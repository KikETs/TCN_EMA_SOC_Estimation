...
- temperatures detected: `0C, 25C, 45C`
...
- Median SOC IQR changed from `0.015` in raw V-I bins to `0.009` when also stratifying by causal current and voltage-response history tertiles.
