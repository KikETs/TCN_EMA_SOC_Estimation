...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--data-root", default="data/raw/NMC_SAMSUNG_INR_18650_2Ah")
    p.add_argument(
        "--out",
        default="paper_ema_analysis_package/section2_measurement_structure/figures/Figure_1_current_voltage_soc_by_profile.tif",
    )
